    ...
    <>
      ...
      <div className="relative flex items-center justify-center min-h-screen overflow-hidden" style={{ background: "#F4EFE4" }}>
        ...
        <div className="absolute top-8 left-8 pointer-events-auto">
          <div className="blob-wrap" style={{ width: 200, height: 200 }}>
            <svg className="blob-A" width={200} height={200} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.88 }}>
        ...
        <div className="absolute top-4 right-10 pointer-events-auto">
          <div className="blob-wrap" style={{ width: 230, height: 230 }}>
            <svg className="blob-B" width={230} height={230} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.87 }}>
        ...
        <div className="absolute bottom-12 left-12 pointer-events-auto">
          <div className="blob-wrap" style={{ width: 170, height: 170 }}>
            <svg className="blob-C" width={170} height={170} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.86 }}>
        ...
        <div className="absolute bottom-14 right-14 pointer-events-auto">
          <div className="blob-wrap" style={{ width: 195, height: 195 }}>
            <svg className="blob-D" width={195} height={195} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.88 }}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-xs font-black uppercase tracking-widest mb-1" style={{ fontFamily: "'Boogaloo', Arial, sans-serif", color: "#111" }}>
                Full Name
              </label>
              <input
                id="name"
              ...
              />
              {errors.name && (
                <p className="text-red-600 text-xs mt-1 font-semibold">{errors.name.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              <p className="text-xs mt-1 font-semibold" style={{ fontFamily: "'Boogaloo', Arial, sans-serif", color: "#666" }}>
